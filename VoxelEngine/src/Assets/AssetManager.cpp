...
uint32_t AssetManager::LoadTextureFromFile(const std::string& fullpath)
{
	uint32_t id;
	glGenTextures(1, &id);
...
uint32_t AssetManager::LoadTextureFromFile(const std::string& path, const std::string& directory)
{
